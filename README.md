...
`` `bash
> 2 otelefones celulares (1 para executar SC, 1 para ler o código QR sis) ou se vc tiver o kali n precisa
> armazenamento adequado
> aplicativo whatsapp
> aplicativo termux ou sistema operacional  kali linux
> café + cigarros KKKK;-;
```
INSTALAÇÃO:
...
> git clone https://github.com/jaoflex/BOTjaoflex.git
> cd BOTjaoflex
